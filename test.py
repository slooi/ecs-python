...
class TestWorld(unittest.TestCase):
	...
	def test_do_all_components_exist_in_newly_added(self):
		world = World()
		h = Health(1)
		world.add_entity(h)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h)==True,True)
		world.update()
		...
		world.add_entity(h)
		world.add_entity(h2)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h,h2)==True,True)
		world.update()
		self.assertEqual(world.do_all_components_exist_in_newly_added(h)==False,True)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h2)==False,True)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h,h2)==False,True)
		...
		world.add_entity(h2)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h3)==True,True)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h,h2,h3)==True,True)
		world.update()
		self.assertEqual(world.do_all_components_exist_in_newly_added(h3)==False,True)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h2)==False,True)
		self.assertEqual(world.do_all_components_exist_in_newly_added(h)==False,True)
	...
	def test_check_ccs_in_deleted_view(self):		
		world = World()
		world.add_entity(Armor(1))
		world.stage_remove_components_by_component_constructors_from_all_entities(Armor)
		world.update()
		self.assertEqual(world.check_ccs_in_deleted_view(Armor) == True,True)
		...
		world.update()
		world.update()
		self.assertEqual(world.check_ccs_in_deleted_view(Armor) == False,True)
		...
		world.update()
		world.update()
		world.add_component_instances_to_entity(0,Armor(11))
		world.stage_remove_components_by_component_constructors_from_all_entities(Armor)
		world.update()
		self.assertEqual(world.check_ccs_in_deleted_view(Armor) == True,True)
